...
import { setCategory } from '../reduxFolder/reducers/news_reducer';
      ...
      <View >
        {
          newsImage != null
            ...
            :
            <Text style={styles.infoUnavailable}>
...

        {
          newsContent != null
            ?
            <ScrollView><Text style={styles.newsContent}>{newsContent}</Text></ScrollView>
            :
            <Text style={styles.infoUnavailable}>News description is not available</Text>
        }
      </View>
